...
{
  SystraceSection s("-[RSUIScheduler startSurfaceWithSurfaceId:...]");
...
{
  SystraceSection s("-[RSUIScheduler stopSurfaceWithSurfaceId:]");
...
{
  SystraceSection s("-[RSUIScheduler measureSurfaceWithLayoutConstraints:]");
...
- (void)constraintSurfaceLayoutWithLayoutConstraints:(LayoutConstraints)layoutConstraints
                                       layoutContext:(LayoutContext)layoutContext
                                           surfaceId:(SurfaceId)surfaceId
{
  SystraceSection s("-[RSUIScheduler constraintSurfaceLayoutWithLayoutConstraints:]");
