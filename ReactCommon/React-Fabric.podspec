...
Pod::Spec.new do |s|
  ...
  s.platforms              = { :ios => "10.0", :tvos => "10.0", :osx => "10.15" }
  s.source                 = source
  ...
  s.subspec "components" do |ss|
    ...
    ss.subspec "view" do |sss|
      ...
      sss.pod_target_xcconfig  = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/Folly\" \"$(PODS_TARGET_SRCROOT)/Headers/Public/Yoga\"" }
    end
  end
  ...
  s.subspec "textlayoutmanager" do |ss|
    ss.dependency             folly_dep_name, folly_version
    ss.compiler_flags       = folly_compiler_flags
    ss.source_files         = "react/renderer/textlayoutmanager/platform/{ios,cxx}/**/*.{m,mm,cpp,h}", "react/renderer/textlayoutmanager/*.{m,mm,cpp,h}"
    ss.exclude_files        = "**/tests/*",
                              "**/android/*",
                              "**/cxx/*"
