...
RCT_EXPORT_METHOD(openURL:(NSURL *)URL
                  ...
                  reject:(RCTPromiseRejectBlock)reject __IOS_EXTENSION_UNAVAILABLE("App extensions can't open URLs"))
{
...
RCT_EXPORT_METHOD(openSettings:(RCTPromiseResolveBlock)resolve
                  reject:(__unused RCTPromiseRejectBlock)reject __IOS_EXTENSION_UNAVAILABLE("App extensions can't open URLs"))
{
